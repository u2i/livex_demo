defmodule LivexDemoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LivexDemoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LivexDemoWeb.Gettext, "errors", msg, opts)
    end
  end
